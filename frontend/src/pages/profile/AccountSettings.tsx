...
export const AccountSettings: React.FC<AccountSettingsModalProps> = ({ isOpen, onClose }) => {
    ...
    const [IsOpenUnsubscribe, setOpenUnsubscribe] = useState<boolean>(false);
    const handleUnsubscribeShow = () => { setOpenUnsubscribe((prev) => !prev) };
    ...
    return (
        <>
                ...
                <form
                    ...
                    <div>
                        ...
                        <input
                            ...
                            required
                        />
                        <span className='text-xs uppercase flex gap-2 items-center pt-[2px] px-[10px]'>
                            {user?.verified ? (
                                <>
                                    <div className="w-2 h-2 bg-[var(--mauve-pink)] rounded-full" /> UnProven
                                </>

                            ) : (
                                <>
                                    <div className="w-2 h-2 bg-[var(--forest-pastel)] rounded-full" />Verified
                                </>
                    ...
                    <div
                        ...
                        className='text-right cursor-pointer text-xs hover:underline hover:text-[var(--forest-pastel)]'>
                        <p>Unsubscribe</p>
                    </div>
            ...
            <Unsubscribe isOpen={IsOpenUnsubscribe} onClose={handleUnsubscribeShow} />
        </>
