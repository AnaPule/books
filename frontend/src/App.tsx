...
import {DiscussionRoomPage} from "@pages/room/DiscussionRoomPage";
      ...
      <AuthProvider>
        <PageTemplate>
          <Routes>
            ...
            <Route path='/book/:book_id/room/:room_id' element={<ProtectedRoute><DiscussionRoomPage /></ProtectedRoute>} />
